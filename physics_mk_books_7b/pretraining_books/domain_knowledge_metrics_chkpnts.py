...
# np.random.seed(42)
# rand_ixs = np.random.randint(0, len(test), 400)
...
base_chkpnt_path = "llama2-7b-physics-books/checkpoint-"
...
# all_chkpnts = list( range(200, 2500, 200) ) + [2500]
all_chkpnts = [2500]

for chkpnt_iter in all_chkpnts:
    chkpnt_path = base_chkpnt_path + str(chkpnt_iter)
    
    print("chkpnt_path = ", chkpnt_path)
