...
df = pd.read_csv("train_coaxnn_paper.csv")
...
batch_size = 8
output_dir_name = 'llama2-7b-coaxnn-paper'
args = TrainingArguments(
    output_dir=output_dir_name,
    num_train_epochs=10, # adjust based on the data size
    max_steps=int( 10 * (146 / batch_size) ),
...
model_name="meta-llama2-7b-coaxnn-paper-domain-tuned-merged"
...
hf_model_repo = "ilufy/meta-llama2-7b-coaxnn-paper-domain-tuned-merged"
